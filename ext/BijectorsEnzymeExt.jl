...
# This is solution (2) listed in https://github.com/TuringLang/Bijectors.jl/issues/339.
# Eventually we would like to move to solution (4) but we don't know when we can.
